...
//     const dropdownRefMob = useRef<HTMLDivElement>(null);
    ...
    useEffect(() => {
        function handleClickOutside(event: MouseEvent) {
            if (
                ...
                !dropdownRefMob.current.contains(event.target as Node)
            ) {
                setDropdownOpen(false);
                setDropdownOpenMob(false);
            }
            ...
            <div className="flex items-center justify-between px-6 lg:px-16 py-4">
                ...
                <div className="flex items-center space-x-4 relative">
                    ...
                    <button
                        ...
                        onClick={() => setDropdownOpenMob((prev) => !prev)}
                    >
                        <User size={24} />
                    </button>
                    ...
                    {dropdownOpenMob && (
                        <div
                            ref={dropdownRefMob}
                            className="absolute right-0 top-[50px] w-40 bg-white text-black border rounded-lg shadow-lg py-2 z-50"
                        >
                            <Link
                                href="/orders"
                                className="block px-4 py-2 text-sm hover:bg-gray-100"
